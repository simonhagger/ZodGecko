/**
 * @file src/schemas/coins.by-id.contract.by-contract_address.market_chart/v3.0.1/index.ts
 * @module schemas/coins.by-id.contract.by-contract_address.market_chart/v3.0.1/index
 */
