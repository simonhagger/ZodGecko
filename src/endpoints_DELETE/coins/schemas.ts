...
import { buildCoinResponseShape, CoinMarketData } from "../_shared/coin.js";
...
//     total_value_locked: z.union([VsQuote, VsQuoteString]).nullable().optional(), // docs show TVL by vs currency
 ...
 */
export const CoinsByIdResponseSchema = buildCoinResponseShape({
  includeTickers: true, // ID route commonly includes tickers (still optional)
});
